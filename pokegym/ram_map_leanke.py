...
def silph_co(game):
    ...
    return sum(
        [
            Beat_Silph_Co_2F_Trainer_0,
            Beat_Silph_Co_2F_Trainer_1,
            Beat_Silph_Co_2F_Trainer_2,
            Beat_Silph_Co_2F_Trainer_3,
            Silph_Co_2_Unlocked_Door1,
            Silph_Co_2_Unlocked_Door2,
            Beat_Silph_Co_3F_Trainer_0,
            Beat_Silph_Co_3F_Trainer_1,
            Silph_Co_3_Unlocked_Door1,
            Silph_Co_3_Unlocked_Door2,
            Beat_Silph_Co_4F_Trainer_0,
            Beat_Silph_Co_4F_Trainer_1,
            Beat_Silph_Co_4F_Trainer_2,
            Silph_Co_4_Unlocked_Door1,
            Silph_Co_4_Unlocked_Door2,
            Beat_Silph_Co_5F_Trainer_0,
            Beat_Silph_Co_5F_Trainer_1,
            Beat_Silph_Co_5F_Trainer_2,
            Beat_Silph_Co_5F_Trainer_3,
            Silph_Co_5_Unlocked_Door1,
            Silph_Co_5_Unlocked_Door2,
            Silph_Co_5_Unlocked_Door3,
            Beat_Silph_Co_6F_Trainer_0,
            Beat_Silph_Co_6F_Trainer_1,
            Beat_Silph_Co_6F_Trainer_2,
            Silph_Co_6_Unlocked_Door,
            Beat_Silph_Co_7F_Trainer_0,
            Beat_Silph_Co_7F_Trainer_1,
            Beat_Silph_Co_7F_Trainer_2,
            Beat_Silph_Co_7F_Trainer_3,
            Silph_Co_7_Unlocked_Door1,
            Silph_Co_7_Unlocked_Door2,
            Silph_Co_7_Unlocked_Door3,
            Beat_Silph_Co_8F_Trainer_0,
            Beat_Silph_Co_8F_Trainer_1,
            Beat_Silph_Co_8F_Trainer_2,
            Silph_Co_8_Unlocked_Door,
            Beat_Silph_Co_9F_Trainer_0,
            Beat_Silph_Co_9F_Trainer_1,
            Beat_Silph_Co_9F_Trainer_2,
            Silph_Co_9_Unlocked_Door1,
            Silph_Co_9_Unlocked_Door2,
            Silph_Co_9_Unlocked_Door3,
            Silph_Co_9_Unlocked_Door4,
            Beat_Silph_Co_10F_Trainer_0,
            Beat_Silph_Co_10F_Trainer_1,
            Silph_Co_10_Unlocked_Door,
            Beat_Silph_Co_11F_Trainer_0,
            Beat_Silph_Co_11F_Trainer_1,
            Silph_Co_11_Unlocked_Door,
            Got_Master_Ball,
            Beat_Silph_Co_Giovanni,
            Silph_Co_Receptionist_At_Desk,
        ]
    )
...
def rock_tunnel(game):
    ...
    return sum(
        [
            Beat_Rock_Tunnel_1_Trainer_0,
            Beat_Rock_Tunnel_1_Trainer_1,
            Beat_Rock_Tunnel_1_Trainer_2,
            Beat_Rock_Tunnel_1_Trainer_3,
            Beat_Rock_Tunnel_1_Trainer_4,
            Beat_Rock_Tunnel_1_Trainer_5,
            Beat_Rock_Tunnel_1_Trainer_6,
            Beat_Rock_Tunnel_2_Trainer_0,
            Beat_Rock_Tunnel_2_Trainer_1,
            Beat_Rock_Tunnel_2_Trainer_2,
            Beat_Rock_Tunnel_2_Trainer_3,
            Beat_Rock_Tunnel_2_Trainer_4,
            Beat_Rock_Tunnel_2_Trainer_5,
            Beat_Rock_Tunnel_2_Trainer_6,
            Beat_Rock_Tunnel_2_Trainer_7,
        ]
    )
...
def rock_tunnel_events(game):
    ...
    return events_status_rock_tunnel
...
def ssanne(game):
    ...
    return sum(
        [
            Beat_Ss_Anne_5_Trainer_0,
            Beat_Ss_Anne_5_Trainer_1,
            Rubbed_Captains_Back,
            Ss_Anne_Left,
            Walked_Past_Guard_After_Ss_Anne_Left,
            Started_Walking_Out_Of_Dock,
            Walked_Out_Of_Dock,
            Beat_Ss_Anne_8_Trainer_0,
            Beat_Ss_Anne_8_Trainer_1,
            Beat_Ss_Anne_8_Trainer_2,
            Beat_Ss_Anne_8_Trainer_3,
            Beat_Ss_Anne_9_Trainer_0,
            Beat_Ss_Anne_9_Trainer_1,
            Beat_Ss_Anne_9_Trainer_2,
            Beat_Ss_Anne_9_Trainer_3,
            Beat_Ss_Anne_10_Trainer_0,
            Beat_Ss_Anne_10_Trainer_1,
            Beat_Ss_Anne_10_Trainer_2,
            Beat_Ss_Anne_10_Trainer_3,
            Beat_Ss_Anne_10_Trainer_4,
...
def mtmoon(game):
    ...
    return sum(
        [
            Beat_Mt_Moon_1_Trainer_1,
            Beat_Mt_Moon_1_Trainer_2,
            Beat_Mt_Moon_1_Trainer_3,
            Beat_Mt_Moon_1_Trainer_4,
            Beat_Mt_Moon_1_Trainer_5,
            Beat_Mt_Moon_1_Trainer_6,
            Beat_Mt_Moon_1_Trainer_7,
            Beat_Mt_Moon_Super_Nerd,
            Beat_Mt_Moon_3_Trainer_0,
            Beat_Mt_Moon_3_Trainer_1,
            Beat_Mt_Moon_3_Trainer_2,
            Beat_Mt_Moon_3_Trainer_3,
            Got_Dome_Fossil,
            Got_Helix_Fossil,
        ]
    )
...
def monitor_hmtm_events(game):
    hmtm_events_dict = {
        'got_hm01_cut': int(read_bit(game, 0xD803, 0)),
        'got_hm02_fly': int(read_bit(game, 0xD7E0, 6)),
        'got_hm03_surf': int(read_bit(game, 0xD857, 0)),
        'got_hm04_strength': int(read_bit(game, 0xD78E, 0)),
        'got_hm04_flash': int(read_bit(game, 0xD7C2, 0)),
    }
    return hmtm_events_dict
...
def oak(game):
    ...
    return sum(
        [
            ...
            got_starter,
            followed_oak_into_lab_2,
            got_pokedex,
            got_oaks_parcel,
            pallet_after_getting_pokeballs,
            oak_got_parcel,
...
def towns(game):
    ...
    return sum(
        [
            got_town_map,
            entered_blues_house,
            beat_viridian_forest_trainer_0,
            beat_viridian_forest_trainer_1,
            beat_viridian_forest_trainer_2,
            got_nugget,
            nugget_reward_available,
            beat_cerulean_rocket_thief,
            got_bicycle,
            seel_fan_boast,
            pikachu_fan_boast,
            got_poke_flute,
...
def mansion(game):
    ...
    return sum(
        [
            beat_mansion_2_trainer_0,
            beat_mansion_3_trainer_0,
            beat_mansion_3_trainer_1,
            beat_mansion_4_trainer_0,
            beat_mansion_4_trainer_1,
            mansion_switch_on,
            beat_mansion_1_trainer_0,
        ]
    )
...
def monitor_dojo_events(game):
    events_status_dojo = {
        "defeated_fighting_dojo": EVENT * int(read_bit(game, 0xD7B1, 0)),
        "beat_karate_master": GYM_LEADER * int(read_bit(game, 0xD7B1, 1)),
        "beat_dojo_trainer_0": TRAINER * int(read_bit(game, 0xD7B1, 2)),
        "beat_dojo_trainer_1": TRAINER * int(read_bit(game, 0xD7B1, 3)),
        "beat_dojo_trainer_2": TRAINER * int(read_bit(game, 0xD7B1, 4)),
...
def hideout(game):
    ...
    return sum(
        [
            beat_rocket_hideout_1_trainer_0,
            beat_rocket_hideout_1_trainer_1,
            beat_rocket_hideout_1_trainer_2,
            beat_rocket_hideout_1_trainer_3,
            beat_rocket_hideout_1_trainer_4,
            beat_rocket_hideout_2_trainer_0,
            beat_rocket_hideout_3_trainer_0,
            beat_rocket_hideout_3_trainer_1,
            beat_rocket_hideout_4_trainer_0,
            beat_rocket_hideout_4_trainer_1,
            beat_rocket_hideout_4_trainer_2,
            rocket_hideout_4_door_unlocked,
            rocket_dropped_lift_key,
...
def poke_tower(game):
    ...
    return sum(
        [
            beat_pokemontower_3_trainer_0,
            beat_pokemontower_3_trainer_1,
            beat_pokemontower_3_trainer_2,
            beat_pokemontower_4_trainer_0,
            beat_pokemontower_4_trainer_1,
            beat_pokemontower_4_trainer_2,
            beat_pokemontower_5_trainer_0,
            beat_pokemontower_5_trainer_1,
            beat_pokemontower_5_trainer_2,
            beat_pokemontower_5_trainer_3,
            beat_pokemontower_6_trainer_0,
            beat_pokemontower_6_trainer_1,
            beat_pokemontower_6_trainer_2,
            beat_ghost_marowak,
            beat_pokemontower_7_trainer_0,
            beat_pokemontower_7_trainer_1,
            beat_pokemontower_7_trainer_2,
        ]
    )  # in_purified_zone,
...
def calculate_gym_score(game, leader_address, leader_bit, trainer_addresses, trainer_bits):
    leader_score = GYM_LEADER * int(read_bit(game, leader_address, leader_bit))
    trainer_scores = [
        GYM_TRAINER * int(read_bit(game, addr, bit))
        for addr, bit in zip(trainer_addresses, trainer_bits)
    ]
    return sum([leader_score] + trainer_scores)


def gym_scores(game):
    scores = [
        calculate_gym_score(game, 0xD755, 7, [0xD755], [2]),
        calculate_gym_score(game, 0xD75E, 7, [0xD75E, 0xD75E], [2, 3]),
        calculate_gym_score(game, 0xD773, 7, [0xD773] * 4 + [0xD773, 0xD773], [2, 3, 4, 1, 0]),
        calculate_gym_score(game, 0xD792, 1, [0xD77C] * 7 + [0xD77D], list(range(2, 8)) + [0]),
        calculate_gym_score(game, 0xD7B3, 1, [0xD792] * 6, list(range(2, 8))),
        calculate_gym_score(game, 0xD7B3, 1, [0xD7B3] * 7 + [0xD7B4], list(range(2, 8)) + [0]),
        calculate_gym_score(game, 0xD79A, 1, [0xD79A] * 7 + [0xD79B], list(range(2, 8)) + [0]),
        calculate_gym_score(
            game,
            0xD751,
            1,
            [0xD751] * 7 + [0xD752] * 2,
            list(range(2, 8)) + [0, 1],
            GYM_TASK * int(read_bit(game, 0xD74C, 0)),
        ),
    ]
    return scores


# def calculate_gym_scores(game, gyms):
#     return [GYM_LEADER * int(read_bit(game, leader, lb)) + sum(GYM_TRAINER * int(read_bit(game, addr, bit)) for addr, bit in zip(addrs, bits)) for leader, lb, addrs, bits in gyms]
# gyms_info = [
#     (0xD755, 7, [0xD755], [2]),
#     (0xD75E, 7, [0xD75E, 0xD75E], [2, 3]),
#     (0xD773, 7, [0xD773]*4 + [0xD773, 0xD773], [2, 3, 4, 1, 0]),
#     (0xD792, 1, [0xD77C]*7 + [0xD77D], list(range(2, 8)) + [0]),
#     (0xD7B3, 1, [0xD792]*6, list(range(2, 8))),
#     (0xD7B3, 1, [0xD7B3]*7 + [0xD7B4], list(range(2, 8)) + [0]),
#     (0xD79A, 1, [0xD79A]*7 + [0xD79B], list(range(2, 8)) + [0]),
#     (0xD751, 1, [0xD751]*7 + [0xD752]*2, list(range(2, 8)) + [0, 1], GYM_TASK * int(read_bit(game, 0xD74C, 0)))
# ]
# scores = calculate_gym_scores(game, gyms)
...
def gym2(game):
    ...
    g2_1 = GYM_TRAINER * int(
        read_bit(game, 0xD75E, 2)
    )  # "0xD75E-2": "Beat Cerulean Gym Trainer 0",
    g2_2 = GYM_TRAINER * int(
        read_bit(game, 0xD75E, 3)
...
def gym3(game):
    ...
    g3_1 = GYM_TRAINER * int(
        read_bit(game, 0xD773, 2)
    )  # "0xD773-2": "Beat Vermilion Gym Trainer 0",
    g3_2 = GYM_TRAINER * int(
        read_bit(game, 0xD773, 3)
    )  # "0xD773-3": "Beat Vermilion Gym Trainer 1",
    g3_3 = GYM_TRAINER * int(
        read_bit(game, 0xD773, 4)
...
def gym7(game):
    ...
    g7_2 = GYM_TRAINER * int(
        read_bit(game, 0xD79A, 3)
    )  # "0xD79A-3": "Beat Cinnabar Gym Trainer 1",
    g7_3 = GYM_TRAINER * int(
        read_bit(game, 0xD79A, 4)
    )  # "0xD79A-4": "Beat Cinnabar Gym Trainer 2",
    g7_4 = GYM_TRAINER * int(
        read_bit(game, 0xD79A, 5)
    )  # "0xD79A-5": "Beat Cinnabar Gym Trainer 3",
    g7_5 = GYM_TRAINER * int(
        read_bit(game, 0xD79A, 6)
    )  # "0xD79A-6": "Beat Cinnabar Gym Trainer 4",
    g7_6 = GYM_TRAINER * int(
        read_bit(game, 0xD79A, 7)
    )  # "0xD79A-7": "Beat Cinnabar Gym Trainer 5",
    g7_7 = GYM_TRAINER * int(
        read_bit(game, 0xD79B, 0)
...
def gym8(game):
    ...
    g8_2 = GYM_TRAINER * int(
        read_bit(game, 0xD751, 3)
    )  # "0xD751-3": "Beat Viridian Gym Trainer 1",
    g8_3 = GYM_TRAINER * int(
        read_bit(game, 0xD751, 4)
    )  # "0xD751-4": "Beat Viridian Gym Trainer 2",
    g8_4 = GYM_TRAINER * int(
        read_bit(game, 0xD751, 5)
    )  # "0xD751-5": "Beat Viridian Gym Trainer 3",
    g8_5 = GYM_TRAINER * int(
        read_bit(game, 0xD751, 6)
    )  # "0xD751-6": "Beat Viridian Gym Trainer 4",
    g8_6 = GYM_TRAINER * int(
        read_bit(game, 0xD751, 7)
    )  # "0xD751-7": "Beat Viridian Gym Trainer 5",
    g8_7 = GYM_TRAINER * int(
        read_bit(game, 0xD752, 0)
    )  # "0xD752-0": "Beat Viridian Gym Trainer 6",
    g8_8 = GYM_TRAINER * int(
        read_bit(game, 0xD752, 1)
...
def monitor_gym8_events(game):
    events_status_gym8 = {
        ...
        "eight": GYM_LEADER * int(read_bit(game, 0xD751, 1)),  # "Beat Viridian Gym Giovanni" (Viridian)
        ...
        "g8_4": GYM_TRAINER * int(read_bit(game, 0xD751, 5)),  # "Beat Viridian Gym Trainer 3",
        "g8_5": GYM_TRAINER * int(read_bit(game, 0xD751, 6)),  # "Beat Viridian Gym Trainer 4",
        "g8_6": GYM_TRAINER * int(read_bit(game, 0xD751, 7)),  # "Beat Viridian Gym Trainer 5",
        "g8_7": GYM_TRAINER * int(read_bit(game, 0xD752, 0)),  # "Beat Viridian Gym Trainer 6",
        "g8_8": GYM_TRAINER * int(read_bit(game, 0xD752, 1)),  # "Beat Viridian Gym Trainer 7",
    }
    return events_status_gym8
